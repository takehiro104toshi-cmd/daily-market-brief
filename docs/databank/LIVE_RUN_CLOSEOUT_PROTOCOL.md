...
| `p43b2b-delivery-handoff.yml` | 5 | 7分 |
| `p43b2c-pages-preview.yml` | 10 | 12分 |
...
| Phase 4 P4-3b2b Handoff | `::P43B2B_HEAD/SELECTION/ARTIFACT/PUBLICATION/SAFETY/END::` |
| Phase 4 P4-3b2c Pages preview | `::P43B2C_HEAD/SELECTION/SELECTION_RESULT/ARTIFACT/MANIFEST/GATE/GRAFT/MANIFEST_VERIFY/HYGIENE/LEGACY_FAILURE/GRAFT_REJECTED::` |
